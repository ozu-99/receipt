...
`,
  ...
  const cacheStatus = cacheRead > 0 ? `HIT (${cacheRead}tok)` : cacheWrite > 0 ? `MISS — write (${cacheWrite}tok)` : 'no-cache';
  console.log(`[usage] in=${freshInput} out=${out} cache=${cacheStatus}`);
