...
- 위 키워드 중 하나라도 들어가면 무조건 영어 번역에 "CCM" 단어를 포함시킴 (Contemporary Christian Music)
- ❌ 절대 사용 금지 단어: hymn, hymns, worship song, worship music, praise song, praise music, gospel song, sacred song, choir song
- ✅ 사용 권장: CCM, a CCM song, CCM music
- 동사구 형태: "Sent you CCM" / "Gave you a CCM song" / "Lifted you with CCM" / "Comforted you with CCM"
- 단순 명사 "찬양"/"찬송"/"워십"만 입력되면 → "Sent you CCM"
- "워십"이 단독으로 나오면 예배 집회가 아니라 CCM 음악으로 해석 (예배 집회는 "예배"/"카운트다운"으로 명시될 때만)
- "예배에서 부른 찬양" → 예배 자리에서 부른 CCM이라는 뜻이므로 "Lifted you with CCM" 등으로 CCM 포함
...
- "찬송가 한 곡" → {"intent":"찬송가를 받음","category":"other","translation":"Sent you a CCM song","oncePerLife":false,"isPartner":false,"isInfinite":false,"isFamilyLove":false,"isSpecific":true}
